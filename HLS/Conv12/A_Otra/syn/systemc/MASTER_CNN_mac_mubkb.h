...
#ifndef __MASTER_CNN_mac_mubkb__HH__
#define __MASTER_CNN_mac_mubkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(MASTER_CNN_mac_mubkb) {
    ...
    SC_CTOR(MASTER_CNN_mac_mubkb):  simcore_mac_0_U ("simcore_mac_0_U") {
