...
#ifndef __MASTER_CNN_mul_50fYi__HH__
#define __MASTER_CNN_mul_50fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MASTER_CNN_mul_50fYi) {
    ...
    SC_CTOR(MASTER_CNN_mul_50fYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
