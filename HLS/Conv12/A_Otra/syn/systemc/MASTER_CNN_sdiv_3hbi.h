...
#ifndef __MASTER_CNN_sdiv_3hbi__HH__
#define __MASTER_CNN_sdiv_3hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MASTER_CNN_sdiv_3hbi) {
    ...
    SC_CTOR(MASTER_CNN_sdiv_3hbi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
