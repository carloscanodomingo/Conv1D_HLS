...
#ifndef __MASTER_CNN_mul_mucud__HH__
#define __MASTER_CNN_mul_mucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MASTER_CNN_mul_mucud) {
    ...
    SC_CTOR(MASTER_CNN_mul_mucud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
