...
#ifndef __MASTER_CNN_mul_muibs__HH__
#define __MASTER_CNN_mul_muibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MASTER_CNN_mul_muibs) {
    ...
    SC_CTOR(MASTER_CNN_mul_muibs):  ACMP_smul_us_U ("ACMP_smul_us_U") {
